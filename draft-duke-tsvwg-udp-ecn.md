...
docname: draft-duke-tsvwg-udp-ecn
...
IPPROTO_IP and type IP_RECVTOS.

If the incoming packet is IPv6, the socket will include a cmsg of level
IPPROTO_IPV6 and type IP_RECVTCLASS.

The resulting byte of data is the entire Type-of-Service (TOS) byte from the
